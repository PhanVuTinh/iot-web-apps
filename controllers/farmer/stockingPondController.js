    ...
    service.get(options, function(error, result) {
        if (error) {
            ...
            if (result.Error) {
                ...
                if (result.data != null) {
                    res.render('farmer/stockingpond/createStockingPond', {
                        title: 'Thêm chi tiết thả nuôi',
                ...
                service.get(options, function(error, result) {
                    if (error) {
                        ...
                        if (result.Error) {
                            ...
                            if (result.data != null) {
                                res.render('farmer/stockingpond/detailStockingPond', {
                                    title: 'Chi tiết thả nuôi ao ' + result.data.pond_id,
                                    conf: config.urladdress,
                                    token: token,
                                    userId: req.user.id,
                                    fullName: req.session.fullName,
