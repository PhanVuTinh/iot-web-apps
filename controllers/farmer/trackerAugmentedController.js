                ...
                service.get(options, function(error, result) {
                    if (error) {
                        ...
                        if (result.Error) {
                            ...
                            if (result.data != null) {
                                res.render('farmer/trackerAugmented/addTrackerAugmented', {
                                    title: 'Thêm chi tiết theo dõi ao ' + result.data.pond_id,
                ...
                service.get(options, function(error, result) {
                    if (error) {
                        ...
                        if (result.Error) {
                            ...
                            if (result.data != null) {
                                res.render('farmer/trackerAugmented/trackerAugmentedList', {
                                    title: 'Bảng theo dõi tăng trưởng ao  ' + result.data.pond_id,
                                    conf: config.urladdress,
                                    token: token,
                                    userId: req.user.id,
                                    fullName: req.session.fullName,
