...
// thu vien upload anh cua Dan su dung module multer
...
// file là tên được định nghĩa trong input
// end thu vien upload anh cua Dan su dung module multer ======
...
postController.post('/them', upload.single('file'), function(req, res) {
    ...
    var body = {
        ...
        post_smallPicture: "/upload/" + req.file.filename,
