...
pondController.get('/lichsuao',service.ensureAuthenticated,function(req,res){
	res.render("manager/ao/lichsuao",{title:"Lịch sử ao",secu:config.securitycode,conf:config.urladdress,token:req.session.token,userid:req.session.userid,username:req.session.username,fullName:req.session.fullName});
});
