...
function showDataTableOfStation(maxDate) {
    ...
    var html =
        '<div class="col-md-12">' +
        '<table class="table  table-hover  " id="dataTable" style=" border-collapse: collapse;">' +
        '<thead>' +
        '<tr class="text-center bg-primary">' +
        '<th width = "25%" class="text-center">Thông Số Đo</th>' +
            ...
            if (rs.data.Items.length > 0) {
                rs.data.Items.forEach(function(bill) {
                    ...
                    var html =
                        ...
                        '<td><a title="Chi tiết hóa đơn" href="/quantrac/nongdan/hoadon/capnhat/' + bill.bill_id + '"><image src="/images/icons/icon-chitiet.png" id="icon-chitiet"/><br/>Chi tiết</td>' +
                        '</tr>';
...
function usingSessionStorageForBill() {
    if (typeof(Storage) !== "undefined") {
        ...
        if (sessionStorage.bill) {
            ...
            console.log(" hala" + bill.dateInBill);
            ...
            if (rs.data.Items.length > 0) {
                rs.data.Items.forEach(function(havest) {
                    html =
                        ...
                        '<td><a title="Cập nhật thu hoach" href="/quantrac/nongdan/thuhoach/capnhat/' + havest.harvest_id + '"><image src="/images/icons/icon-chitiet.png" id="icon-chitiet"/><br/>Chi tiết</td>' +
                        '</tr>';
                ...
                callback: function(data, pagination) {
                    ...
                    data.forEach(function(Item) {
                        html +=
                            ...
                            '<td>' + ((Item.materialtype_id == 2) ? 'Thức Ăn' : '') + '</td>' +
                            ...
                            '<td>' + Item.bill_id + '</td>' +
                            '<td><a title="Xoá vật tư" href="#" onclick="deleteMaterialTypeFood(' + "'" + conf + "'" + ',' + "'" + token + "'" + ',' + "'" + userid + "'" + ',' + Item.material_id + ')"><i class="fa fa-trash-o fa-2x" aria-hidden="true"></i></a></td>' +
                            '</tr>';
                    });
...
function getStockingbyUserId(conf, token, userID, callback) {
    jQuery.ajax({
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            displayError("Lỗi ! Không thể tải dữ liệu của vụ nuôi. Vui lòng tải lại trang");
        },
    });
}
//hàm lấy danh sách vật liệu theo loại vật liệu <Hoa>
function getLimeType(conf, token, callback) {
    jQuery.ajax({
        url: conf + '/api/material/getbymaterialtype/5',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            displayError("Lỗi ! Không thể tải dữ liệu của vôi. Vui lòng tải lại trang");
        },
    });
}
//hàm lấy danh sách vật liệu theo loại vật liệu <Hoa>
function getFishKill(conf, token, callback) {
    jQuery.ajax({
        url: conf + '/api/material/getbymaterialtype/6',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            displayError("Lỗi ! Không thể tải dữ liệu của chất diệt cá. Vui lòng tải lại trang");
        },
    });
}
//hàm lấy danh sách loại hóa chất xử lý nước<Hoa>
function getWaterTreatment(conf, token, callback) {
    jQuery.ajax({
        url: conf + '/api/material/getbymaterialtype/7',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            displayError("Lỗi ! Không thể tải dữ liệu của hóa chất xử lý nước. Vui lòng tải lại trang");
        },
    });
}
//hàm lấy danh sách loại phân vô cơ<Hoa>
function getInorganic(conf, token, callback) {
    jQuery.ajax({
        url: conf + '/api/material/getbymaterialtype/8',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            displayError("Lỗi ! Không thể tải dữ liệu của phân vô cơ. Vui lòng tải lại trang");
        },
    });
}
//hàm lấy danh sách loại phân hữu cơ<Hoa>
function getOrganic(conf, token, callback) {
    jQuery.ajax({
        url: conf + '/api/material/getbymaterialtype/9',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            displayError("Lỗi ! Không thể tải dữ liệu của phân hữu cơ. Vui lòng tải lại trang");
        },
    });
}
//hàm lấy danh sách loại quạt nước<Hoa>
function getWaterfan(conf, token, callback) {
    jQuery.ajax({
        url: conf + '/api/material/getbymaterialtype/10',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            displayError("Lỗi ! Không thể tải dữ liệu của quạt nước. Vui lòng tải lại trang");
        },
    });
}
//hàm lấy danh sách loại đất<Hoa>
function getLand(conf, token, callback) {
    jQuery.ajax({
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            displayError("Lỗi ! Không thể tải dữ liệu của đất. Vui lòng tải lại trang");
        },
    });
}

//hàm lấy danh sách ao trong stocking_pond<Hoa>
function getPondInStockingPond(conf, token, userId, callback) {
    jQuery.ajax({
        ...
        success: function(result) {
            ...
            var stockingpond = result.data;
            stockingpond.forEach(function(stocking) {
                jQuery.ajax({
                    url: conf + '/api/pond/getbyid/' + stocking.pond_id,
                    type: 'GET',
                    contentType: 'application/json; charset=utf-8',
                    headers: {
                        'Authorization': token
                    ...
                    contentType: 'application/json; charset=utf-8',
                    success: function(resultpond) {
                        callback(resultpond.data);
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        displayError("Lỗi ! Không thể tải");
                    }
                });
            });
        },
...
//hàm lấy danh sách ao trong stocking_pond<Hoa>
function getStockingInStockingPond(conf, token, userId, callback) {
    jQuery.ajax({
        url: conf + '/api/stockingpond/getall/',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        ...
        success: function(result) {
            ...
            stockingpond.forEach(function(stocking) {
                jQuery.ajax({
                    url: conf + '/api/stocking/getbyid/' + stocking.stocking_id,
                    type: 'GET',
                    contentType: 'application/json; charset=utf-8',
                    headers: {
                        'Authorization': token
                    ...
                    contentType: 'application/json; charset=utf-8',
                    success: function(resultstocking) {
                        callback(resultstocking.data);
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        displayError("Lỗi ! Không thể tải");
                    }
...
//hàm lấy danh sách giống<Hoa>
function getSeed(conf, token, userID, callback) {
    jQuery.ajax({
...
//hàm lấy danh sách ao trong pond_preparation<Hoa>
function getPondInPondPreparation(conf, token, userId, callback) {
    jQuery.ajax({
        url: conf + '/api/pondpreparation/getall/',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
...
//hàm lấy danh sách ao trong pondpreparation<Hoa>
function getStockingInPondPreparation(conf, token, userId, callback) {
    jQuery.ajax({
        url: conf + '/api/pondpreparation/getall/',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
...
//hàm thêm chất diệt cá<Hoa>
function postFishSkill(host, token) {
    var stocking_id = $("#stocking_id_1").val();
    var pond_id = $("#pond_id_1").val();
    var matepredetail_quantity = parseFloat($("#quantityfishkill_id").val());
    var matepredetail_number = parseInt($("#fishkillnumber_id").val());
    if (matepredetail_quantity <= 0) {
        matepredetail_quantity = $("#quantityfishkill_id").val("");
        alert("Số lượng chất diệt cá không hợp lệ");
    }
    if (matepredetail_number <= 0) {
        matepredetail_number = $("#fishkillnumber_id").val("");
        alert("Số vật liệu không hợp lệ");
    }
    var request = jQuery.ajax({
        url: host + '/api/pondpreparation/getbystockingpond?stocking_id=' + stocking_id + '&pond_id=' + pond_id,
        method: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
    ...
    request.done(function(resultdata) {
        var pondprepar_id = "";
        var pondpre = resultdata.data;
        pondpre.forEach(function(index) {
            pondprepar_id = index.pondpreparation_id;
            var fishkill_id = $("#fishkill_id").val();
            var request1 = jQuery.ajax({
                ...
                data: {
                    pondpreparation_id: pondprepar_id,
                    material_id: fishkill_id,
                    //matepredetail_quantity : parseFloat($("#quantityfishkill_id").val()),
                    matepredetail_date: $("#fishkillday_id").val(),
                    matepredetail_note: $("#fishkillnote_id").val(),
                    //matepredetail_number : parseInt($("#fishkillnumber_id").val())
                },
            });
            console.log(request1);
            request1.done(function(rs) {
                //callback(rs);
                console.log("Success");
            });
        });
    ...
    request.fail(function(jqXHR, textStatus, errorThrown) {
        displayError("Lỗi ! Không thể thêm vật liệu");
    });
}

//hàm thêm vôi<Hoa>
function postLime(host, token) {
    var stocking_id = $("#stocking_id_1").val();
    var pond_id = $("#pond_id_1").val();
    var matepredetail_quantity = parseFloat($("#quantitylime_id").val());
    var matepredetail_number = parseInt($("#limenumber_id").val());
    if (matepredetail_quantity <= 0) {
        matepredetail_quantity = $("#quantitylime_id").val("");
        alert("Số lượng vôi không hợp lệ");
    }
    if (matepredetail_number <= 0) {
        matepredetail_number = $("#limenumber_id").val("");
        alert("Số vật liệu không hợp lệ");
    }
    var request = jQuery.ajax({
        url: host + '/api/pondpreparation/getbystockingpond?stocking_id=' + stocking_id + '&pond_id=' + pond_id,
        ...
        pondpre.forEach(function(index) {
            ...
            var request1 = jQuery.ajax({
                ...
                data: {
                    pondpreparation_id: pondprepar_id,
                    material_id: lime_id,
                    //matepredetail_quantity : parseFloat($("#quantitylime_id").val()),
                    matepredetail_quantity: matepredetail_quantity,
                    matepredetail_date: $("#limeday_id").val(),
                    matepredetail_note: $("#limenote_id").val(),
                    //matepredetail_number : parseInt($("#limenumber_id").val())
            ...
            request1.done(function(rs) {
                //callback(rs);
                console.log("Success");
                confirm("Thêm dữ liệu thành công");
            });
            request1.fail(function(rs) {
                alert("Thêm dữ liệu thất bại! Vui lòng kiểm tra lại.");
            });
        });
    });
    request.fail(function(jqXHR, textStatus, errorThrown) {
...
//hàm thêm chất xử lý nước<Hoa>
function postWatertreat(host, token) {
    var stocking_id = $("#stocking_id_1").val();
    var pond_id = $("#pond_id_1").val();
    var matepredetail_quantity = parseFloat($("#quantitytreat_id").val());
    var matepredetail_number = parseInt($("#watertreatnumber_id").val());
    if (matepredetail_quantity <= 0) {
        matepredetail_quantity = $("#quantitytreat_id").val("");
        alert("Số lượng chất xử lý nước không hợp lệ");
    }
    if (matepredetail_number <= 0) {
        matepredetail_number = $("#watertreatnumber_id").val("");
        alert("Số vật liệu không hợp lệ");
    }
    var request = jQuery.ajax({
        url: host + '/api/pondpreparation/getbystockingpond?stocking_id=' + stocking_id + '&pond_id=' + pond_id,
    ...
    request.done(function(resultdata) {
        ...
        pondpre.forEach(function(index) {
            pondprepar_id = index.pondpreparation_id;
            var watertreat_id = $("#watertreat_id").val();
            var request1 = jQuery.ajax({
                url: host + '/api/materialpreparationdetail/create',
                type: 'POST',
                headers: {
                ...
                data: {
                    pondpreparation_id: pondprepar_id,
                    material_id: watertreat_id,
                    //matepredetail_quantity : parseFloat($("#quantitytreat_id").val()),
                    matepredetail_quantity: matepredetail_quantity,
                    matepredetail_date: $("#watertreatday_id").val(),
                    matepredetail_note: $("#watertreatnote_id").val(),
                    //matepredetail_number : parseInt($("#watertreatnumber_id").val())
                    matepredetail_number: matepredetail_number
                },
            });
            request1.done(function(rs) {
...
//hàm thêm phân vô cơ<Hoa>
function postInorganic(host, token) {
    var stocking_id = $("#stocking_id_1").val();
    var pond_id = $("#pond_id_1").val();
    var matepredetail_quantity = parseFloat($("#quantityinorganic_id").val());
    var matepredetail_number = parseInt($("#inorganicnumber_id").val());
    if (matepredetail_quantity <= 0) {
        matepredetail_quantity = $("#quantityinorganic_id").val("");
        alert("Số lượng phân vô cơ không hợp lệ");
    }
    if (matepredetail_number <= 0) {
        matepredetail_number = $("#inorganicnumber_id").val("");
        alert("Số vật liệu không hợp lệ");
    }
    var request = jQuery.ajax({
        url: host + '/api/pondpreparation/getbystockingpond?stocking_id=' + stocking_id + '&pond_id=' + pond_id,
    ...
    request.done(function(resultdata) {
        ...
        pondpre.forEach(function(index) {
            pondprepar_id = index.pondpreparation_id;
            var inorganic_id = $("#inorganic_id").val();
            var request1 = jQuery.ajax({
                url: host + '/api/materialpreparationdetail/create',
                type: 'POST',
                headers: {
                ...
                data: {
                    pondpreparation_id: pondprepar_id,
                    material_id: inorganic_id,
                    //matepredetail_quantity : parseFloat($("#quantityinorganic_id").val()),
                    matepredetail_quantity: matepredetail_quantity,
                    matepredetail_date: $("#inorganicday_id").val(),
                    matepredetail_note: $("#inorganicnote_id").val(),
                    //matepredetail_number : parseInt($("#inorganicnumber_id").val())
                    matepredetail_number: matepredetail_number
                },
            });
            request1.done(function(rs) {
...
//hàm thêm phân hữu cơ<Hoa>
function postOrganic(host, token) {
    var stocking_id = $("#stocking_id_1").val();
    var pond_id = $("#pond_id_1").val();
    var matepredetail_quantity = parseFloat($("#quantityorganic_id").val());
    var matepredetail_number = parseInt($("#organicnumber_id").val());
    if (matepredetail_quantity <= 0) {
        matepredetail_quantity = $("#quantityorganic_id").val("");
        alert("Số lượng phân hữu cơ không hợp lệ");
    }
    if (matepredetail_number <= 0) {
        matepredetail_number = $("#organicnumber_id").val("");
        alert("Số vật liệu không hợp lệ");
    }
    var request = jQuery.ajax({
        url: host + '/api/pondpreparation/getbystockingpond?stocking_id=' + stocking_id + '&pond_id=' + pond_id,
    ...
    request.done(function(resultdata) {
        ...
        pondpre.forEach(function(index) {
            ...
            var request1 = jQuery.ajax({
                ...
                data: {
                    pondpreparation_id: pondprepar_id,
                    material_id: organic_id,
                    //matepredetail_quantity : parseFloat($("#quantityorganic_id").val()),
                    matepredetail_quantity: matepredetail_quantity,
                    matepredetail_date: $("#organicday_id").val(),
                    matepredetail_note: $("#organicnote_id").val(),
                    //matepredetail_number : parseInt($("#organicnumber_id").val())
                    matepredetail_number: matepredetail_number
                },
            });
            request1.done(function(rs) {
...
//hàm thêm máy quạt<Hoa>
function postWaterfan(host, token) {
    var stocking_id = $("#stocking_id_1").val();
    var pond_id = $("#pond_id_1").val();
    var matepredetail_quantity = parseFloat($("#quantityfan_id").val());
    var matepredetail_number = parseInt($("#waterfannumber_id").val());
    if (matepredetail_quantity <= 0) {
        matepredetail_quantity = $("#quantityfan_id").val("");
        alert("Số lượng máy quạt không hợp lệ");
    }
    if (matepredetail_number <= 0) {
        matepredetail_number = $("#waterfannumber_id").val("");
        alert("Số vật liệu không hợp lệ");
    }
    var request = jQuery.ajax({
        url: host + '/api/pondpreparation/getbystockingpond?stocking_id=' + stocking_id + '&pond_id=' + pond_id,
    ...
    request.done(function(resultdata) {
        ...
        pondpre.forEach(function(index) {
            pondprepar_id = index.pondpreparation_id;
            var waterfan_id = $("#waterfan_id").val();
            var request1 = jQuery.ajax({
                url: host + '/api/materialpreparationdetail/create',
                type: 'POST',
                headers: {
                ...
                data: {
                    pondpreparation_id: pondprepar_id,
                    material_id: waterfan_id,
                    //matepredetail_quantity : parseFloat($("#quantityfan_id").val()),
                    matepredetail_quantity: matepredetail_quantity,
                    matepredetail_date: $("#waterfanday_id").val(),
                    matepredetail_note: $("#waterfannote_id").val(),
                    //matepredetail_number : parseInt($("#waterfannumber_id").val())
                    matepredetail_number: matepredetail_number
                },
            });
            request1.done(function(rs) {
...
//hàm lấy danh sách ngày trong harvest<Hoa>
function getDateInHarvest(conf, token, callback) {
    jQuery.ajax({
        url: conf + '/api/harvest/getall',
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
...
//hàm thêm thu hoạch
function postHarvest(conf, token, userid, callback) {
    var harvest_harvestDate = $('#harvest_harvestDate').val();
    if (harvest_harvestDate == "") {
        alert("Vui lòng thêm ngày thu hoạch");
    }
    var request = jQuery.ajax({
        url: host + '/api/harvest/create',
        method: 'POST',
        ...
        data: {
            user_id: userid,
            stocking_id: $('#stocking_id').val(),
            //harvest_harvestDate : $('#harvest_harvestDate').val()
            harvest_harvestDate: harvest_harvestDate
        }
    });
    request.done(function(rs) {
...
//hàm lấy danh sách product_type<Hoa>
function getProductType(conf, token, callback) {
    jQuery.ajax({
...
//hàm lấy danh sách unit<Hoa>
function getUnit(conf, token, callback) {
    jQuery.ajax({
...
//hàm thêm chi tiết thu hoạch
// function postHarvestDetail(conf, token, callback){
//     var harvedeta_number = $('#harvedeta_number').val();
//     var harvedeta_price = $('#harvedeta_price').val();

//     var request =  jQuery.ajax({
//          url : host + '/api/harvestdetail/create',
//          method: 'POST',
//          contentType: 'application/json; charset=utf-8',		
//          headers: {			
//                  'Content-Type' : 'application/x-www-form-urlencoded',
...
//          },
//          data:{
//             //harvedeta_number : $('#harvedeta_number').val(),
//             harvedeta_number : harvedeta_number,
//             harvest_id : $('#harvest_id').val(),
//             prodtype_id	 : $('#prodtype_id').val(),
//             pond_id : $('#pond_id').val(),
//             unit_id: $('#unit_id').val(),
//             //harvedeta_price : $('#harvedeta_price').val(),
...
function getListPondbyUserId(host, token, userid, index, pagesize) {
    var keyword = "";
    var totals = "";
    var html = "";
    var html2 = "";
    ...
    jQuery.ajax({
        url: host + '/api/pond/getpagination/' + userid + '?page=' + index + '&pageSize=' + pagesize + '&keyword=' + keyword,
        type: 'GET',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Authorization': token
        ...
        success: function(resultdata) {
                ...
                resultdata.data.Items.forEach(function(items) {
                    if (!items.isDelete) {
                        if (items.user_id == userid) {
                            ...
                            html += "<td><a title='Cập nhật thông tin ao' href='/quantrac/nongdan/aonuoi/capnhataonuoi/" + items.pond_id + "'>";
                            html += "<span class='fa fa-pencil-square-o fa-2x'></a></td>";
                            //             html += "<td><a title='Xem lịch sử nuôi của ao' href='/quantrac/quanly/nhatkynuoi/xemlichsunuoi/"+ items.pond_id +"'>";
                            // html += '<i class="fa fa-history fa-2x"></i></a></td>';
                            //             html += "<td><a title='Xem hoạt động chăm sóc' href='/quantrac/quanly/hoatdong/xemhoatdongchamsoc/"+ items.pond_id +"'>";
                            // html += '<i class="fa fa-list-alt fa-2x"></i></a></td>';
                            //   			html += '<td><a id="btn_xoa" title="Xóa thông tin ao" href="#" onclick="eventDeletePond('+ "'" + conf + "'" + ',' + "'" + token + "'" + ',' + "'" + secu + "'" + ',' + items.pond_id + ',' + "'" + items.user_id + "'" + ',' + "'" + items.region_id + "'" +')">';
                            //   html += '<i class="fa fa-trash fa-2x"></i></a></td>';
                            html += '</tr>';
                        }
                    }
                });
            ...
            if (totals != 0) {
                if (totals > 1) {
                    for (i = 1; i <= totals; i++) {
                        html2 += '<li><a href="#" onclick="processPaginationPond(' + "'" + conf + "'" + ',' + "'" + token + "'" + ',' + "'" + userid + ',' + index + ',' + pagesize + ');return false;">' + i + '</a></li>';
                    }
...
function processPaginationPond(conf, token, userid, index, pagesize) {
    ...
    $(selector).on('click', function() {
        ...
        // var pagesize = 10;
        getListPondbyUserId(conf, token, userid, (page - 1), pagesize);
    });
}
//ham lay ve danh sach vung dua tren id user
function getAllRegionByUserId(conf, token, userid, callback) {
    jQuery.ajax({
